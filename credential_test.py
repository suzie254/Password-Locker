...
class TestCredential(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credential = Credential("susan","akinyi","123456","suzieakinyi@gmail.com") # create Account object

    
    def test_init(self):
        

        self.assertEqual(self.new_credential.credential_name,"susan")
        self.assertEqual(self.new_credential.user_name,"akinyi")
        self.assertEqual(self.new_credential.password,"123456")
        self.assertEqual(self.new_credential.email,"suzieakinyi@gmail.com")
