...
def main():
    print("Hello! Welcome to Sue's password-locker application")
    user_name = input()
        ...
        if short_code == 'su':
            ...
            if check_existing_user(search_user):
                ...
                print('\n')
                    ...
                    print(f"Thanks {user_name} for your time.I hope you enjoyed my service.Chao!...")
                    break
        else:
                    print("What do you mean! Please use the short codes provided")
