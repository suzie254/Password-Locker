...
class TestUser(unittest.TestCase):
     ...
     def setUp(self):
          ...
          self.new_user = User("Susan", "Akinyi", "suzieakinyi", "suzie254")
     ...
     def test_init(self):
        ...
        self.assertEqual(self.new_user.user_name,"suzieakinyi")
        self.assertEqual(self.new_user.password,"suzie254")
     ...
     def test_save_multiple_user(self):
       ...
       '''
        self.new_user.save_user()
        test_user = User("Facebook","Susan","suzieakinyi","suzie254") 
        test_user.save_user()
     ...
     def test_find_user_by_username(self):
         ...
         found_user = User.find_by_user_name("suzieakinyi")
     ...
     def test_user_exists(self):
         ...
         user_exists = User.user_exist("suzieakinyi")
